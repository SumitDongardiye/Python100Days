...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.right_btn=Button(image=self.right_img,highlightthickness=0,command=self.true_pressed)
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_questions():
            ...
            self.canvas.itemconfig(self.question_text,text=f"You've reached the end of the quiz. Final Score: {self.quiz.score}/{self.quiz.question_number}")
